                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="media d-sm-flex d-block text-center text-sm-left pb-4 mb-4 border-bottom">
                                        <img alt="image" class="rounded mr-sm-4 mr-0" width="130" src="images/avatar/1.jpg">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <p class="fs-18 text-dark font-w600 mb-0"><a href="https://eres.dexignzone.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1d74737b725d78657c707178337e7270">[email&#160;protected]</a></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="assigned-doctor2 owl-carousel">
                                <div class="items">
                                    <div class="media bg-white p-4 rounded align-items-center">
                                        <img class="mr-3" src="images/doctors/6.jpg" alt="">
                                ...
                                <div class="items">
                                    <div class="media bg-white p-4 rounded align-items-center">
                                        <img class="mr-3" src="images/doctors/7.jpg" alt="">
                                        <div class="media-body d-block d-sm-flex  align-items-center justify-content-between">
                                            <div class="mr-2">
                                ...
                                <div class="items">
                                    <div class="media bg-white p-4 rounded align-items-center">
                                        <img class="mr-3" src="images/doctors/8.jpg" alt="">
                                        <div class="media-body d-block d-sm-flex  align-items-center justify-content-between">
                                            <div class="mr-2">
