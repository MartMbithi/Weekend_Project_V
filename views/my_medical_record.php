                ...
                <div class="container-fluid">
                    <div class="page-titles">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="my_medical_records">Medical Records</a></li>
                                    ...
                                    <div class="media d-sm-flex d-block text-center text-sm-left pb-4 mb-4 border-bottom">
                                        ...
                                        <div class="media-body align-items-center">
                                            <div class="d-sm-flex d-block justify-content-between my-3 my-sm-0">
                                                <div>
                                                    <h3 class="fs-22 text-black font-w600 mb-0"><?php echo $row->user_name; ?></h3>
                                                    <p class="mb-2 mb-sm-2">Registered On <?php echo $row->user_date_added; ?></p>
                                                </div>
                                                <span>#<?php echo $row->user_number; ?></span>
                                            </div>
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <p class="fs-18 text-dark"><?php echo $row->user_address; ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 mb-lg-0 mb-3">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <p class="fs-18 text-dark font-w600 mb-0"><?php echo $row->user_phone; ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <p class="fs-18 text-dark font-w600 mb-0"><?php echo $row->user_email; ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
